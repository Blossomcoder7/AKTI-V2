...
const GetStartedButton = () => {
  ...
  return (
    <>
      <div
        className={clsx(
          "relative  group z-5  mb-3.5 cursor-pointer",
        )}
        onClick={() => {
          gsap.to(window, {
      ...
      >
        <div className=" w-full h-full flex gap-10 justify-center items-center bg-gradient-to-b px-7 py-4 group-hover:opacity-90 from-[#590B25] via-[#740832] to-[#941845] rounded-2xl">
