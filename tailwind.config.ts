...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Main brand
        "akti-burgundy": "#590b25",
        "akti-burgundy-light": "#740832",
        "akti-copper": "#673446",
        "akti-sand": "#f2c8b6",
        "akti-sky": "#cddef4",
        "akti-fire": "#df2a2c",
        "akti-grey": "#735e64",
        "akti-savana": "#be6455",
        "akti-warm-grey": "#c1b2b6",
        "akti-sage": "#afc8be",
        "akti-white": "#ffffff",
      },
      fontFamily: {
        lama: ["Lama Sans Regular", "sans-serif"],
        // Condensed variation
        "lama-condensed": ["Lama Sans Condensed", "sans-serif"],
        // Expanded variation
        "lama-expanded": ["Lama Sans Expanded", "sans-serif"],
      },
      fontSize: {
